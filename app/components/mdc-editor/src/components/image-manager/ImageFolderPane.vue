...
import type { EditorTabItem, ImageManagerData } from "@/types/mdc-editor";
...
const props = defineProps({
  tab: {
    type: Object as PropType<
      EditorTabItem & { type: "image-manager"; data: ImageManagerData }
    >,
    required: true,
  ...
  <div class="p-4 h-full overflow-hidden flex flex-col">
    <div class="flex justify-between items-center mb-4">
      <div class="flex gap-4">
        <UButton icon="ep:plus" @click="handleOpenUploadModal()">
          上传
        </UButton>
      </div>
    ...
    <ImageUploadModal
      v-if="props.tab.type === 'image-manager'"
