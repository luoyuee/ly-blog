...
const categoryFormModalRef = useTemplateRef("categoryFormModalRef");
const categoryDetailsModalRef = useTemplateRef("categoryDetailsModalRef");

const handleOpenFormModal = (e?: ArticleCategoryItem) => {
  categoryFormModalRef.value?.open(e);
};

const handleOpenDetailsModal = (e: ArticleCategoryItem) => {
  categoryDetailsModalRef.value?.open(e);
};

const handleOpenHitokoto = (e: ArticleCategoryItem) => {
...
<template>
  <div class="mdc-article-category-manager" @contextmenu.prevent>
    ...
    <CategoryFormModal ref="categoryFormModalRef" @submit="loadData" />
    <CategoryDetailsModal ref="categoryDetailsModalRef" />
  </div>
</template>
